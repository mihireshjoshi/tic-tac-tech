  ...
  return (
    <View style={styles.container}>
      <LinearGradient
        ...
        style={styles.card}
      >
        <Text style={styles.label}>{jsonData.hin.Account_id}</Text>
        <Text style={styles.accountNumber}>{accountId}</Text>
        <Text style={styles.balanceLabel}>{jsonData.hin.AvailableBalance}</Text>
        ...
        >
          <Text style={styles.buttonText}>{jsonData.hin.ViewTransactions}</Text>
        </TouchableOpacity>
      </LinearGradient>
    </View>
  );
