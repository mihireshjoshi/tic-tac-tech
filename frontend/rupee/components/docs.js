...
const Documents = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>{jsonData.hin.Documents}</Text>
      <View style={styles.optionsContainer}>
        <TouchableOpacity style={styles.option} onPress={() => handleDocumentClick('Fixed Deposit')}>
          ...
          >
            ...
            <Text style={styles.optionText}>{jsonData.hin.FixedDeposit}</Text>
          </LinearGradient>
        </TouchableOpacity>
        <TouchableOpacity style={styles.option} onPress={() => handleDocumentClick('Loan Application')}>
          ...
          >
            ...
            <Text style={styles.optionText}>{jsonData.hin.LoanApplication}</Text>
          </LinearGradient>
        </TouchableOpacity>
        <TouchableOpacity style={styles.option} onPress={() => handleDocumentClick('Credit Card Application')}>
          ...
          >
            ...
            <Text style={styles.optionText}>{jsonData.hin.CreditCardApplication}</Text>
          </LinearGradient>
        </TouchableOpacity>
      </View>
    </View>
