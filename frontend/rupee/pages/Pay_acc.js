...
export default function PayScreen() {
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <Text style={styles.label}>{jsonData.hin.EnterAccountNumber}</Text>
      <TextInput
        style={styles.input}
        placeholder={jsonData.hin.AccountNumber}
        value={accountNumber}
        onChangeText={setAccountNumber}
      />
      <Text style={styles.label}>{jsonData.hin.EnterAmount}</Text>
      <TextInput
        style={styles.input}
        placeholder={jsonData.hin.Amount}
        value={amount}
        onChangeText={setAmount}
        keyboardType="numeric"
      />
      <TouchableOpacity style={styles.button} onPress={handlePay}>
        <Text style={styles.buttonText}>{jsonData.hin.Pay}</Text>
      </TouchableOpacity>
